onmessage = function(options) {
	...
	let iteration = 0, hash = null;
	let startIteration = parseInt(options.data.startIteration);
...
// MD5-hashing code from http://www.myersdaily.org/joseph/javascript/md5-text.html
